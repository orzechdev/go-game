...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    SET_BOARD_VALUES(state, values) {
      state.boardValues = values;
    },
    SET_ALGORITHM_TYPE(state, type) {
      state.algorithmsTypeSelected = type;
    },
    SET_CALCULATION_DEPTH(state, depth) {
      state.calculationDepthSelected = depth;
    }
  },
  actions: {
